...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2022 at 07:45 AM
...
(1, 'samarinda seberang', 15000),
(2, 'loabakung', 15000),
(3, 'samarinda utara', 10000),
(4, 'loajanan', 15000),
(5, 'cendana', 10000),
(6, 'sungai kunjang', 10000),
(7, 'sungai pinang', 20000),
(8, 'sentosa', 10000);
...
INSERT INTO `pembelian` (`id_pembelian`, `id_user`, `id_produk`, `id_ongkir`, `jumlah`, `tanggal`, `harga`) VALUES
(2, 2, 4, 5, 1, '2022-11-29', 15000),
(4, 2, 4, 2, 1, '2022-11-29', 20000),
(5, 2, 4, 7, 1, '2022-11-29', 25000);
